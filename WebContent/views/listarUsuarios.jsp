...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/jquery-ui-1.11.4.custom/jquery-ui.js"></script>
<!-- Bootstrap CSS -->
...
<table class="table table-striped">
	...
	<tbody>
			<tr>
				...
				<td> <input
							type="button" class="btn btn-default" value="Deshabilitar" />
					</td>
				<td>
			</tr>
			<tr>
...
<table class="table table-striped">
	...
	<tbody>
			<tr>
				...
				<td> <input
							type="button" class="btn btn-default" value="Habilitar" />
					</td>
				<td>
			</tr>
			<tr>
